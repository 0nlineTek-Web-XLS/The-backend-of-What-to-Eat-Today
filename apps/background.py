...
@background.post("/manager/signin/", status_code=201, response_description="created successfully", summary="注册")
...
# 删除管理员（拥有超级管理员权限才可使用）
@background.delete("/manager/", status_code=201, response_description="deleted successfully",
                   summary="删除管理员")
...
# 增加新餐厅
@background.post("/canteens/", status_code=200, response_description="added successfully", summary="增加新餐厅",
...
# 菜品管理接口
# 增加新菜品
@background.post("/dishes/", status_code=200, response_description="added successfully", summary="增加新菜品")
